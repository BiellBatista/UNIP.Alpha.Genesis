...
public class Conexao {
	...
	public static Connection getConexao() {
		if(con == null){// caso nao exista uma conexao
			try{
				...
				JOptionPane.showMessageDialog(null, "Problemas com Parâmetros da conexão!", e.getMessage(), JOptionPane.ERROR_MESSAGE);
			}
		}
	...
	public static void closeConexao() {
		try{
			...
			JOptionPane.showMessageDialog(null, "Erro:Não foi possível fechar a conexão com BD!");
		}
	}
}